        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="flex justify-center space-x-4">
              ...
              <Link
                href="#how-it-works"
                className="px-6 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 text-lg font-medium"
              >
                How It Works
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
              <div className="mb-4">
                <span className="inline-block p-2 bg-green-100 rounded-lg">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
              <div className="mb-4">
                <span className="inline-block p-2 bg-purple-100 rounded-lg">
          ...
          <div id="how-it-works" className="bg-gray-50 p-8 rounded-2xl mb-16">
      ...
      <footer className="bg-gray-50 border-t border-gray-200 mt-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4">TimeKill</h3>
          ...
          <div className="mt-8 pt-8 border-t border-gray-200 flex flex-col sm:flex-row justify-between">
